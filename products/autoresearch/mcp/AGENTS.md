...
- **Backed by** — `../backend/presentation/views/views.py`. A tool is only as good as its serializer annotations; `help_text` and `@extend_schema` flow directly into these schemas.
