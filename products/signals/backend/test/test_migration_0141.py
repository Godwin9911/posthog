...
# Non-atomic: the preceding indexes use CONCURRENTLY, which an atomic rewind cannot replay.
...
class BackfillReportStalenessClocksMigrationTest(NonAtomicTestMigrations):
    ...
    migrate_from = "0140_signalreport_staleness_indexes"
    migrate_to = "0141_backfill_report_staleness_clocks"
