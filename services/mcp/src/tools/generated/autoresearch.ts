...
const AutoresearchSuggestionsRetrieveSchema = () => {
    const AutoresearchSuggestionsRetrieveParams = orvalSchemas.AutoresearchSuggestionsRetrieveParams()
    return AutoresearchSuggestionsRetrieveParams.omit({ project_id: true })
}

const autoresearchSuggestionsRetrieve = (): ToolBase<
    ReturnType<typeof AutoresearchSuggestionsRetrieveSchema>,
    Schemas.AutoresearchSuggestion
> => ({
    name: 'autoresearch-suggestions-retrieve',
    schema: AutoresearchSuggestionsRetrieveSchema(),
    handler: async (context: Context, params: z.infer<ReturnType<typeof AutoresearchSuggestionsRetrieveSchema>>) => {
        const projectId = await context.stateManager.getProjectId()
        const result = await context.api.request<Schemas.AutoresearchSuggestion>({
            method: 'GET',
...
const AutoresearchTrainingRunsArtifactsDeleteCreateSchema = () => {
    const AutoresearchTrainingRunsArtifactsDeleteCreateBody =
        orvalSchemas.AutoresearchTrainingRunsArtifactsDeleteCreateBody()
    const AutoresearchTrainingRunsArtifactsDeleteCreateParams =
        orvalSchemas.AutoresearchTrainingRunsArtifactsDeleteCreateParams()
    return AutoresearchTrainingRunsArtifactsDeleteCreateParams.omit({ project_id: true }).extend(
        AutoresearchTrainingRunsArtifactsDeleteCreateBody.shape
    )
}

const autoresearchTrainingRunsArtifactsDeleteCreate = (): ToolBase<
    ReturnType<typeof AutoresearchTrainingRunsArtifactsDeleteCreateSchema>,
...
> => ({
    ...
    handler: async (
        context: Context,
        params: z.infer<ReturnType<typeof AutoresearchTrainingRunsArtifactsDeleteCreateSchema>>
    ) => {
        const projectId = await context.stateManager.getProjectId()
        const body: Record<string, unknown> = {}
...
const AutoresearchValidateOnlineCreateSchema = () => {
    const AutoresearchValidateOnlineCreateParams = orvalSchemas.AutoresearchValidateOnlineCreateParams()
    return AutoresearchValidateOnlineCreateParams.omit({ project_id: true })
}

const autoresearchValidateOnlineCreate = (): ToolBase<
    ReturnType<typeof AutoresearchValidateOnlineCreateSchema>,
    Schemas.AutoresearchRun[]
> => ({
    name: 'autoresearch-validate-online-create',
    schema: AutoresearchValidateOnlineCreateSchema(),
    handler: async (context: Context, params: z.infer<ReturnType<typeof AutoresearchValidateOnlineCreateSchema>>) => {
        const projectId = await context.stateManager.getProjectId()
        const result = await context.api.request<Schemas.AutoresearchRun[]>({
            method: 'POST',
